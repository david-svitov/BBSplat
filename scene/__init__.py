...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0],
        ...
        if os.path.exists(os.path.join(args.source_path, "sparse")):
            scene_info = sceneLoadTypeCallbacks["Colmap"](args.source_path, args.images, args.eval, max_points=max_read_points)
        elif os.path.exists(os.path.join(args.source_path, "transforms_train.json")):
            print("Found transforms_train.json file, assuming Blender data set!")
            scene_info = sceneLoadTypeCallbacks["Blender"](args.source_path, args.white_background, args.eval, max_points=max_read_points)
        ...
        if self.loaded_iter:
            folder_path = os.path.join(self.model_path, "point_cloud", "iteration_" + str(self.loaded_iter))
    ...
    def save(self, iteration):
        ...
        self.gaussians.save_texture(point_cloud_path)
